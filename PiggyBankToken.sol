...
/**
              ...
              69 420 69 420  - PIGGY BANK - 69 420 69 420 
                                      ,
                                   ,nNN
                                ,nNNNN'
                             ,nNNNNNN;
...
contract PiggyBankToken is Context, IERC20, Ownable {
    ...
    string private _name = "Piggy Bank Token";
    ...
    function _transfer(
        ...
        // Make sure we're only getting requests from addresses which are not blacklisted
        // we do this to make sure the the correct PancakeSwapPair is used
...
/*
            // Code from KimJongMoon - not implmented as I'm not 100% clear the balanceOf pair/WETH work as expected
            //  
